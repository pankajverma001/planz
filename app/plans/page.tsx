...
export default function Plans() {
  ...
  async function contribute() {
    ...
    const newAmount =
      selectedPlan.collected_amount + Number(amount);
    ...
    <main className="min-h-screen bg-[#0B0714] text-white p-5">
      <div className="max-w-[430px] mx-auto">
        ...
        <p className="text-white/50 mt-1">
          Only your personal plans are shown here.
        </p>
            ...
            plans.map((plan, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-white/50 text-sm">{plan.category}</p>
        ...
        {selectedPlan && (
          ...
          >
            ...
            >
              ...
              <p className="text-white/50 mt-1">{selectedPlan.title}</p>
